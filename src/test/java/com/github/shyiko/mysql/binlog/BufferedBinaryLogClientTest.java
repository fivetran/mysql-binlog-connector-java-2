 ...
 */
public class BufferedBinaryLogClientTest {

    @Test
    public void testEventListenersManagement() {
        BufferedBinaryLogClient binaryLogClient = new BufferedBinaryLogClient("localhost", 3306, "root", "mysql");
...
//    }
    ...
    public void testNoConnectionTimeout() throws Exception {
        new BufferedBinaryLogClient("_localhost_", 3306, "root", "mysql").connect(0);
    }

    @Test(timeOut = 15000)
    public void testConnectionTimeout() throws Exception {
        final BufferedBinaryLogClient binaryLogClient = new BufferedBinaryLogClient("localhost", 33059, "root", "mysql");
    ...
    public void testNullEventDeserializerIsNotAllowed() throws Exception {
        new BufferedBinaryLogClient("localhost", 3306, "root", "mysql").setEventDeserializer(null);
    }

    @Test(timeOut = 15000)
    public void testDisconnectWhileBlockedByFBRead() throws Exception {
        final BufferedBinaryLogClient binaryLogClient = new BufferedBinaryLogClient("localhost", 33061, "root", "mysql");
